    ...
    return ( 
        ...
        <div className="AdminStudentCourseList">
          ...
          {error && <div> {error} </div>}
          {
              info && 
              <>
              <AdminStudentCourseList courses={info.StudentCourses} name={info.StudentName.name} url={url}/>
              <Link to={`/admin/studentList/students/${studId}/courses/enrollNewCourses`}>
              <button >
               Enroll New Courses
              </button>
              </Link>
